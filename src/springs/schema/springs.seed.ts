...
export const springs: SpringEntity[] = [
    {
        ...
        composition: [
            ...
            {elementName: 'Bicarbonates', formula: '', quantity: 360, unity: 'mg/L'},
            ...
            {elementName: 'Dissolved solids', formula: '', quantity: 345, unity: 'ppm'},
        ...
        localisation: {longitude: 46.399764, lattitude:6.591661},
    ...
    },
    {
        ...
        composition: [
            ...
            {elementName: 'Dissolved solids', formula: '', quantity: 130, unity: 'ppm'},
            {elementName: 'pH', formula: '', quantity: 7, unity: 'pH'}
        ],
        description: 'L impluvium de Volvic se compose de couches de roches volcanique',
        brand: 'L eau de Volvic',
        price: [
            {price: 15.99, money: 'US Dollar', by: '1L', country: 'USA'},
            {price: 2.40, money: 'Euro', by: '6x0.5L', country: 'France'}
        ],
        localisation: {longitude: 45.886365,lattitude: 3.060074},
